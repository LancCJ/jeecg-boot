 ...
 */
@Data
@TableName("lms_supplier")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="lms_supplier对象", description="供应商")
public class Supplier implements Serializable {
	...
	/**区域编号1*/
	@Excel(name = "区域编号1", width = 15)
    @ApiModelProperty(value = "区域编号1")
    private java.lang.String areaNo1;
	/**区域编号2*/
	@Excel(name = "区域编号2", width = 15)
    @ApiModelProperty(value = "区域编号2")
    private java.lang.String areaNo2;
}
