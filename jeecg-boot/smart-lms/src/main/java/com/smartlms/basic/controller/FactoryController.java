...
import com.smartlms.basic.entity.Factory;
import com.smartlms.basic.service.IFactoryService;
...
public class FactoryController extends JeecgController<Factory, IFactoryService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "厂区信息-分页列表查询")
	@ApiOperation(value="厂区信息-分页列表查询", notes="厂区信息-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "厂区信息-添加")
	@ApiOperation(value="厂区信息-添加", notes="厂区信息-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "厂区信息-编辑")
	@ApiOperation(value="厂区信息-编辑", notes="厂区信息-编辑")
	@PutMapping(value = "/edit")
	public Result<?> edit(@RequestBody Factory factory) {
	 ...
	 * @return
	 */
	@AutoLog(value = "厂区信息-通过id删除")
	@ApiOperation(value="厂区信息-通过id删除", notes="厂区信息-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "厂区信息-批量删除")
	@ApiOperation(value="厂区信息-批量删除", notes="厂区信息-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "厂区信息-通过id查询")
	@ApiOperation(value="厂区信息-通过id查询", notes="厂区信息-通过id查询")
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, Factory factory) {
        return super.exportXls(request, factory, Factory.class, "厂区信息");
    }
