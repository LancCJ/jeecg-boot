...
public class DriverController extends JeecgController<Driver, IDriverService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "驾驶员管理-分页列表查询")
	@ApiOperation(value="驾驶员管理-分页列表查询", notes="驾驶员管理-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "驾驶员管理-添加")
	@ApiOperation(value="驾驶员管理-添加", notes="驾驶员管理-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "驾驶员管理-编辑")
	@ApiOperation(value="驾驶员管理-编辑", notes="驾驶员管理-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "驾驶员管理-通过id删除")
	@ApiOperation(value="驾驶员管理-通过id删除", notes="驾驶员管理-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "驾驶员管理-批量删除")
	@ApiOperation(value="驾驶员管理-批量删除", notes="驾驶员管理-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "驾驶员管理-通过id查询")
	@ApiOperation(value="驾驶员管理-通过id查询", notes="驾驶员管理-通过id查询")
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, Driver driver) {
        return super.exportXls(request, driver, Driver.class, "驾驶员管理");
    }
